      ...
      <section className="scheduled-task-detail" aria-label={creating ? "新建定时任务" : "定时任务编辑器"}>
        {(creating || selected) ? <>
          ...
          <form className="scheduled-task-form" onSubmit={(event) => { event.preventDefault(); void save(); }}>
            ...
            <div className="scheduled-task-skill-block"><div className="scheduled-task-section-heading"><h3>Consumer Agent Skills</h3><span>Trigger 发现真实消息后使用</span></div><div className="scheduled-task-skill-chips"><span className="scheduled-task-skill-chip">ceo-message-triage · Managed</span><span className="scheduled-task-skill-chip">dingtalk-chat · Operation</span></div></div>
