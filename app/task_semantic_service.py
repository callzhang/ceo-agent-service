...
class TaskSemanticService:
    ...
    def _signal_id_or_create(self, *, signal: SourceSignal, db: sqlite3.Connection, now: datetime) -> tuple[int, bool]:
        ...
        return (
            self.store.create_business_task_signal_in_transaction(
    ...
    def record_formal_task(self, command: RecordFormalTask) -> TaskMutationResult:
        ...
        return self._record_new_task(
            ...
            task_fields={
                ...
                "formal_basis": command.formal_basis,
