...
- Always include oa_action_receipt in your final result: use null when no OA action was performed; otherwise include the exact process_instance_id, task_id, action, remark, and read-back result for the verified OA action.
