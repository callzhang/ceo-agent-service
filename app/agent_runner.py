...
- If a required OA detail, task, record, form, attachment, or comment read fails or cannot be parsed, return outcome=failed with code=critical_info_unavailable. Do not send a message, write an OA comment, or otherwise expose this internal dependency failure to the applicant or any chat.
