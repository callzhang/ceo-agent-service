...
- If multiple OA candidates remain, the task is already completed, or the task belongs to another user, do not execute an approval write. Report the concrete safe reason instead.
