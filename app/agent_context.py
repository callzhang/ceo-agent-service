...
7. [oa_applicant_statement] For facts about their own application, the actual OA applicant is authoritative. When the applicant states that requested material was supplied or a related status was corrected, accept the statement, consider that requested correction resolved, and continue from it. Do not require another source to corroborate that statement; a delayed, cached, stale, or conflicting source-system view must not override the applicant. Do not introduce a new supplementary requirement in that review cycle unless an explicitly mandatory OA form field is absent. A reviewer preference, formatting improvement, scoring-method detail, or potential ambiguity must not delay approval. Ask only about mandatory information the applicant has not stated."""
