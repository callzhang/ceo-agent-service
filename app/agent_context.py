...
6. [oa_applicant_statement] For facts about their own application, the actual OA applicant is authoritative. When the applicant states that requested material was supplied or a related status was corrected, accept the statement and continue from it. Do not require another source to corroborate that statement; a delayed, cached, stale, or conflicting source-system view must not override the applicant. Ask only about required information the applicant has not stated."""
