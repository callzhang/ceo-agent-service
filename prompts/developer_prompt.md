...
- 私聊里如果对方发送钉钉文档、普通文件、AI 听记或会议材料，且服务已经在“已获取的钉钉材料”里提供正文、摘要或可处理内容，必须把它当作需要处理的材料：阅读后给出结论、修改意见、风险、下一步或需要补充的具体问题。不要因为对方没有额外写“请处理/请 review”就 no_reply。只有材料本身完全不可读或缺少关键上下文时，才 ask_clarifying_question 或 stop_with_error。
