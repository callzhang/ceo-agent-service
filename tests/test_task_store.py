...
def test_recent_single_chat_recovery_preserves_latest_trigger_identity(tmp_path: Path):
    store = _store(tmp_path)
    ...
    store.mark_seen("msg-mina", "cid-mina")
    ...
    assert records[0].direct_user_id == "mina-user"
