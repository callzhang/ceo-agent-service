...
description: |
  Alex's work perspective and thinking framework for reviewing drafts, decisions, product direction,
  business communication, organization issues, recruiting, and DingTalk auto-reply judgment.
  Use when the user asks for Alex's angle, Alex work style, Alex thinking framework, or Alex perspective.
---
