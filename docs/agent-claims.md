...
| --- | --- | --- | --- |
| codex-task-first-storage-quality | app/store.py (semantic text checks and default list index only), tests/test_task_semantic_store.py, docs/task-semantic-storage.md, docs/agent-claims.md | Isolated task-first-tasks worktree: align SQLite nonblank checks with Python and index default task ordering; no runtime or shared-main changes | 2026-09-22 |
