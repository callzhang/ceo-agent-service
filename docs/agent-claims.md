...
| --- | --- | --- | --- |
| codex-task2-semantic-transitions | app/task_semantic_service.py (new), app/store.py (business semantic transaction helpers only), tests/test_task_semantic_store.py (transaction helper coverage only), tests/test_task_semantic_service.py (new), docs/agent-claims.md | Atomic, append-only Task-first semantic mutations; isolated worktree only, no runtime/API/UI or live DB behavior | 2026-09-22 |
