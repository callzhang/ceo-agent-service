...
| Codex session `heartbeat-current` | `app/cli.py`, `tests/test_cli.py` | propagate partial AI-minutes sync failures from the service-command adapter instead of reporting success | 2026-09-12 |
