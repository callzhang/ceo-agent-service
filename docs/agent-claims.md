...
| Codex session `calendar-card-revision-recovery` | `app/worker.py`, `app/store.py`, `app/agent_cron/seeds.py`, `tests/test_worker.py`, `tests/test_agent_cron_seeds.py`, `README.md`, `CHANGELOG.md`, `docs/superpowers/specs/2026-09-08-agent-cron-and-managed-minutes-skill-design.md` | requeue in-place DingTalk calendar invitation updates through recent-message recovery and bind exact calendar consumer Skills | 2026-09-14 |
