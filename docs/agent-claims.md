...
| --- | --- | --- | --- |
| codex-task-first-create-id-contract | app/store.py (two business create-method return values only), tests/test_task_semantic_store.py, docs/task-semantic-storage.md, docs/agent-claims.md | Task 1 P2 re-review: return persisted integer IDs from source/task creation; reproduce the approved standalone call sequence before fixing | 2026-09-22 |
