...
| --- | --- | --- | --- |
| Codex session `xiaoqing-runtime-result-repair` | `app/consumer_agent.py`, `tests/test_consumer_agent.py` | reject model-authored missing-MCP results and force direct runtime capability use | 2026-09-13 |
