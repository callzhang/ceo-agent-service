...
| Codex session `meeting-memory-content-summary` | `app/meeting_memory_write.py`, `tests/test_meeting_memory_write.py` | stop deriving meeting-memory titles from the first sentence; use the generated meeting content summary | 2026-09-15 |
