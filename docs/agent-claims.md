...
| --- | --- | --- | --- |
| codex-okr-shared-chrome | scripts/dingteam_okr_headless_source.py, tests/test_dingteam_okr_headless_source.py, docs/runtime-mechanism.md, docs/agent-claims.md | Move Dingteam OKR header capture to the shared service Chrome and daily cookie snapshot, removing the private bundled Chromium/CDP launcher | 2026-09-25 |
