...
| Codex session `consumer-attempt-result-design` | `docs/superpowers/specs/2026-09-14-consumer-attempt-result-design.md` | approved design for rendering the current Attempt-linked Consumer result and a later Consumer run state | 2026-09-14 |
