...
| --- | --- | --- | --- |
| codex-task6-retrieval-review-fixes | app/task_retrieval.py, app/task_models.py, tests/test_task_retrieval.py, tests/test_task_models.py, docs/agent-claims.md | Preserve source evidence across semantic retrieval, require verifiable merge references, and require actor provenance for committed dates. Scope limited to Task 6 model and retrieval contracts; no Task Agent, semantic service, Store, UI, or runtime changes. | 2026-09-23 |
