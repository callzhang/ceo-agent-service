...
| --- | --- | --- | --- |
| Codex session `status-null-contract` | `app/web_api/registration.py`, `tests/test_console_status_response.py`, `CHANGELOG.md` | preserve required nullable fields in the React Status API response | 2026-09-13 |
