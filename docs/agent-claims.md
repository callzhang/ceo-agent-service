...
| codex-task-first-tasks-baseline | docs/superpowers/plans/2026-09-22-task-first-tasks.md, docs/agent-claims.md | Correct frontend baseline test path in the approved implementation plan | 2026-09-22 |
