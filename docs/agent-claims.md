...
| codex-pdf-material-reader | app/agent_cli.py, tests/test_agent_cli.py, docs/agent-materials.md | Expose bounded, task-local PDF text extraction through the existing material reader | 2026-09-15 |
