...
| --- | --- | --- | --- |
| codex-task6-retrieval-quality-followup | app/task_retrieval.py (semantic retrieval only), tests/test_task_retrieval.py (semantic retrieval tests only), docs/task-semantic-storage.md (retrieval-context section only), docs/agent-claims.md | Preserve cited owner proof despite evidence cap; require formal-role owner evidence; prioritize confirmed active anchor links before per-task cap. No Store/semantic service/API/UI/runtime/live-data changes. | 2026-09-23 |
