...
| --- | --- | --- | --- |
| codex-task6-semantic-quality-fixes | app/task_semantic_models.py, app/task_semantic_rules.py, app/task_semantic_service.py, app/store.py (business task event migration only), tests/test_task_semantic_service.py, tests/test_task_semantic_store.py, docs/task-semantic-storage.md, docs/agent-claims.md | Repair Task 6 source identity, owner/date/acceptance evidence, dedupe replay, and recoverable business task event migration; semantic scope only, no runtime deploy | 2026-09-23 |
