...
| Codex session `root-attention-fix` | `app/audit_web.py`, `tests/test_console_web_api.py` | take over stale attention projection claim; surface only structured actionable needs_human decisions in Attention | 2026-09-12 |
