...
| claude-codex-stack-route-filter | app/agent_runtime_production.py (router route filter only), tests/test_agent_runtime_production.py, docs/agent-claims.md | Stop offering a Claude route to the Codex/Friday execution stack, which cannot build its command | 2026-09-17 |
