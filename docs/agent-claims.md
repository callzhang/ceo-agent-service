...
| codex-attempt-layout | frontend/src/pages/AttemptDetailPage.tsx, frontend/src/pages/AttemptDetailPage.test.tsx, frontend/src/styles.css | Unify Attempt detail layout: top action bar, two-column main/sidebar, merged processing evidence | 2026-09-15 |
