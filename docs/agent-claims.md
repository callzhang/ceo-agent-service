...
| Codex session `dispatcher-health-fix` | `app/dispatcher/service.py`, `tests/test_consumer_dispatcher.py` | Dispatcher heartbeat observer and regression coverage | 2026-09-11 |
