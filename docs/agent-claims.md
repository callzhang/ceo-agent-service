...
| Codex session `019ed90c-3b33-7922-bc18-4f83044ba267` | `app/store.py`, `tests/test_store.py` | make service-state writes tolerate transient SQLite locks without terminating workers | 2026-09-13 |
