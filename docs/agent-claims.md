...
| --- | --- | --- | --- |
| Codex session `status-null-contract-ui` | `frontend/src/api/console.ts`, `frontend/src/api/console.test.ts`, `app/static/workbench/`, `CHANGELOG.md` | accept the Status API model's explicit null values for optional email and Attention fields | 2026-09-13 |
