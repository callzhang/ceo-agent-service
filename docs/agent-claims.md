...
| codex-unsubscribe-state-marker | app/email_unsubscribe.py, tests/test_email_unsubscribe.py, docs/agent-claims.md | Recognize provider preference pages showing all subscriptions unsubscribed and resubscribe controls | 2026-09-15 |
