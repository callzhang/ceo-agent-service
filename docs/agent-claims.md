...
| Codex session `quality-gate-email-projection-repair` | `app/quality_gate.py`, `tests/test_quality_gate.py` | take over stale quality-gate projection repair for service-generated email unsubscribe decisions; preserve other email/store changes | 2026-09-11 |
