...
| codex-attempt-layout | frontend/src/pages/AttemptDetailPage.tsx, frontend/src/pages/AttemptDetailPage.test.tsx, frontend/src/styles.css, docs/attempt-detail-ui.md | Consolidate Attempt action bar, feedback sidebar/input, Consumer status grid, and email-unsubscribe duplicate sections | 2026-09-15 |
