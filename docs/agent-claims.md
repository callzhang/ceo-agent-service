...
| codex-email-backfill-progress-spec-top | docs/superpowers/specs/2026-09-21-email-backfill-progress-design.md, docs/agent-claims.md | Apply review feedback: show the Email backfill progress directly at the top rather than in a separate card | 2026-09-21 |
