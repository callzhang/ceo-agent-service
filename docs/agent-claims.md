...
| claude-friday-turn-text | app/agent_runtime_router.py (_friday_turn_text and the Friday execute call only), tests/test_routed_codex_execution.py, docs/agent-claims.md | Carry the developer instructions, business Skills and output schema into Friday Runtime's single message | 2026-09-17 |
