...
| --- | --- | --- | --- |
| codex-task-first-semantic-storage | app/task_semantic_models.py, app/store.py (business semantic tables, manifest, and task/signal/evidence methods only), tests/test_task_semantic_store.py, tests/test_store.py (schema manifest only if needed), docs/agent-claims.md | Task-first bounded semantic domain models and durable SQLite storage; no runtime reply-task or legacy work-project semantics | 2026-09-22 |
