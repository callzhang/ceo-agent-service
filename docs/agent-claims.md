...
| --- | --- | --- | --- |
| Codex session `consumer-attempt-result-react` | `app/web_api/attempts.py`, `tests/test_console_attempt_detail_api.py`, `frontend/src/api/attempts.ts`, `frontend/src/pages/AttemptDetailPage.tsx`, `frontend/src/pages/AttemptDetailPage.test.tsx` | expose and render the exact linked Consumer result and current-generation Consumer pending/running state on the live React Attempt detail page | 2026-09-14 |
