...
| codex-history-email-filter | app/store.py (narrow `_operation_logs_base_query` reply history_type branch), tests/test_console_web_api.py | Classify legacy email unsubscribe send_reply projections separately from generic reply history | 2026-09-15 |
