...
| codex-history-legacy-route | app/store.py, app/audit_web.py, app/history.py, tests/test_store.py, tests/test_audit_web.py | Keep legacy `/history` object filtering consistent with console History email unsubscribe separation | 2026-09-15 |
