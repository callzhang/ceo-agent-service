...
| --- | --- | --- | --- |
| codex-meeting-recall-group | app/meeting_alignment.py (delivery receipt flow and group-target diagnosis only), tests/test_meeting_alignment.py (new focused cases only), docs/runtime-mechanism.md (meeting follow-up paragraph only), docs/agent-claims.md | Fix first-send self-recall, then investigate and repair group discovery regression with separate tests and commits | 2026-09-23 |
