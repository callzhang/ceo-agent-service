...
| codex-unsubscribe-recovery-loop | app/email_worker.py, tests/test_email_worker.py | Stop automatic receipt projection from endlessly retrying exhausted no-reliable-entry browser runs | 2026-09-15 |
