...
| Codex session `meeting-memory-content-title` | `app/meeting_memory_write.py`, `tests/test_meeting_memory_write.py`, `CHANGELOG.md` | derive the Memory entry title from delivered conclusion content and move the meeting ID out of the title position | 2026-09-14 |
