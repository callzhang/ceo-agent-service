...
| --- | --- | --- | --- |
| codex-task2-contract-repair | app/task_semantic_service.py, tests/test_task_semantic_service.py, docs/agent-claims.md | Repair Task 2 replay ordering, merge-chain rejection, and formal-basis evidence roles in the isolated task-first-tasks worktree | 2026-09-22 |
