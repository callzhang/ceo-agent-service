...
| codex-task-first-rules-repair | app/task_semantic_service.py (require rule evidence at all formal and merge command boundaries only), tests/test_task_semantic_service.py (Task 3 bypass regressions and updated commands only), docs/agent-claims.md | Repair Task 3 spec-review P1s: prevent omitted merge identity evidence and make existing formal create/promote commands derive from required structured formality evidence. No storage/schema/API/UI/runtime/live-data change. Shipped in `29e6808a`. | 2026-09-22 |
| codex-task-first-rules-docs | docs/task-semantic-storage.md, docs/agent-claims.md | Document Task 3's required structured formality and identity evidence at semantic service boundaries | 2026-09-22 |
