...
os.environ.setdefault("CEO_CURRENT_USER_DISPLAY_NAMES", "磊哥,Derek Zen,Derek,Lei Zhang")
...
os.environ.setdefault(
    ...
    "Derek 的组织职责包括算法负责人；凡是询问算法团队、算法同学、算法分享、算法资源或算法方向是否参与的消息，如果明确 @ Derek，即使同时 @ 了别人，也应视为需要 Derek 回复。",
)
