...
- **分层质量门禁**：`ceo-quality` 提供 PR/full/release 检查、Agent golden/live 评测、数据库迁移演练、脱敏质量快照和 launchd 发布回滚。操作说明见 [docs/quality-system.md](docs/quality-system.md)。
...
- Python 3.12（以 `.python-version` 和 `uv.lock` 为准）
- 已认证的 `dws` CLI
